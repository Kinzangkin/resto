    ...
    <div className='flex'>
      ...
      <div className='flex flex-col items-center justify-center w-[50%]'>
        ...
        <div className='flex flex-col items-center'>
          ...
          <input type="button" value="Register" className='basecolor rounded-2xl px-7 py-2 my-3 cursor-pointer w-fit text-white outline-none' />
        </div>
        ...
        <div className='flex items-center flex-col'>
          ...
          <p className='mt-5'>Already have a account? <span className='text-blue-600 cursor-pointer'>Login now</span></p>
        </div>
      </div>
    </div>
  )
